...
public class QSyntax extends Syntax
{
    ...
    public static final Entry[] entries=new Entry[]
    {
     ...
     //   new Entry(INIT,"-".toCharArray(),79,QTokenContext.OPERATOR,ACTION_LOOKSLIKE),
        ...
        new Entry(1,"z".toCharArray(),22,QTokenContext.TIMESTAMP,ACTION_LOOKSLIKE),
      ...
      //  new Entry(11,"".toCharArray(),INIT,QTokenContext.CHAR_VECTOR,ACTION_MATCHANDPUTBACK),
        ...
        new Entry(22,delimiters,INIT,QTokenContext.TIMESTAMP,ACTION_MATCHANDPUTBACK),
        ...
        new Entry(64,"T".toCharArray(),65,QTokenContext.TIMESTAMP,ACTION_LOOKSLIKE),
        ...
        new Entry(65,digits,66,QTokenContext.TIMESTAMP,ACTION_LOOKSLIKE),
        new Entry(66,digits,67,QTokenContext.TIMESTAMP,ACTION_LOOKSLIKE),
        new Entry(67,":".toCharArray(),68,QTokenContext.TIMESTAMP,ACTION_LOOKSLIKE),
        new Entry(68,digits,69,QTokenContext.TIMESTAMP,ACTION_LOOKSLIKE),
        new Entry(68,delimiters,INIT,QTokenContext.TIMESTAMP,ACTION_MATCHANDPUTBACK),
        new Entry(69,digits,70,QTokenContext.TIMESTAMP,ACTION_LOOKSLIKE),
        new Entry(70,":".toCharArray(),71,QTokenContext.TIMESTAMP,ACTION_LOOKSLIKE),
        new Entry(70,delimiters,INIT,QTokenContext.TIMESTAMP,ACTION_MATCHANDPUTBACK),
        new Entry(71,digits,72,QTokenContext.TIMESTAMP,ACTION_LOOKSLIKE),
        new Entry(72,digits,73,QTokenContext.TIMESTAMP,ACTION_LOOKSLIKE),
        new Entry(73,".".toCharArray(),74,QTokenContext.TIMESTAMP,ACTION_LOOKSLIKE),
        new Entry(73,delimiters,INIT,QTokenContext.TIMESTAMP,ACTION_MATCHANDPUTBACK),
        new Entry(74,digits,75,QTokenContext.TIMESTAMP,ACTION_LOOKSLIKE),
        new Entry(74,delimiters,INIT,QTokenContext.TIMESTAMP,ACTION_MATCHANDPUTBACK),
        new Entry(75,digits,76,QTokenContext.TIMESTAMP,ACTION_LOOKSLIKE),
        new Entry(75,delimiters,INIT,QTokenContext.TIMESTAMP,ACTION_MATCHANDPUTBACK),
        new Entry(76,digits,77,QTokenContext.TIMESTAMP,ACTION_LOOKSLIKE),
        new Entry(77,delimiters,INIT,QTokenContext.TIMESTAMP,ACTION_MATCHANDPUTBACK),

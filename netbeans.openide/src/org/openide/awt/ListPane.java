        ...
        public void keyPressed(KeyEvent e) {
            ...
            if (s < 0) {
                ...
                switch (e.getKeyCode()) {
                    ...
                    case KeyEvent.VK_UP:        s -= realColumnCount; break;
                    case KeyEvent.VK_DOWN:      s += realColumnCount; break;
                    case KeyEvent.VK_HOME:      s = 0; break;
                    case KeyEvent.VK_END:       s = getModel().getSize() - 1; break;
                    case KeyEvent.VK_PAGE_UP:   s -= realColumnCount * realRowCount; break;
                    case KeyEvent.VK_PAGE_DOWN: s += realColumnCount * realRowCount; break;
                    default: return;
                }
            }
            if (s < 0)
